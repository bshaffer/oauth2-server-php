...
class CouchbaseDB extends KeyValueAbstract
{
    ...
    public function __construct($connection, $config = array())
    {
        if ($connection instanceof \Couchbase) {
            ...
            throw new \InvalidArgumentException('First argument to OAuth2\Storage\CouchbaseDB must be an instance of Couchbase or a configuration array containing a servers array');
        }
