    ...
    UserInfoControllerInterface
{
     ...
     */
    public function __construct($storage = array(), array $config = array(), array $grantTypes = array(), array $responseTypes = array(), TokenTypeInterface|null $tokenType = null, ScopeInterface|null $scopeUtil = null, ClientAssertionTypeInterface|null $clientAssertionType = null)
    {
     ...
     */
    public function handleUserInfoRequest(RequestInterface $request, ResponseInterface|null $response = null)
    {
     ...
     */
    public function handleTokenRequest(RequestInterface $request, ResponseInterface|null $response = null)
    {
        $this->response = is_null($response) ? new Response() : $response;
     ...
     * @return mixed
     */
    public function grantAccessToken(RequestInterface $request, ResponseInterface|null $response = null)
    {
        $this->response = is_null($response) ? new Response() : $response;
     ...
     */
    public function handleRevokeRequest(RequestInterface $request, ResponseInterface|null $response = null)
    {
        $this->response = is_null($response) ? new Response() : $response;
     ...
     */
    public function validateAuthorizeRequest(RequestInterface $request, ResponseInterface|null $response = null)
    {
        $this->response = is_null($response) ? new Response() : $response;
     ...
     * @return mixed
     */
    public function verifyResourceRequest(RequestInterface $request, ResponseInterface|null $response = null, $scope = null)
    {
        $this->response = is_null($response) ? new Response() : $response;
     ...
     * @return mixed
     */
    public function getAccessTokenData(RequestInterface $request, ResponseInterface|null $response = null)
    {
        $this->response = is_null($response) ? new Response() : $response;
