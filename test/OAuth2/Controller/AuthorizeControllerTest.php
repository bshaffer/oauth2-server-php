...
class AuthorizeControllerTest extends \PHPUnit_Framework_TestCase
{
    public function testNoClientIdResponse()
    {
        ...
        $response = $server->handleAuthorizeRequest($request, new Response(), false);
        $params = json_decode((string) $response->getBody(), true);

        $this->assertEquals($response->getStatusCode(), 400);
        $this->assertEquals($params['error'], 'invalid_client');
        $this->assertEquals($params['error_description'], 'No client id supplied');
    }
    ...
    public function testInvalidClientIdResponse()
    {
        ...
        $this->assertEquals($response->getStatusCode(), 400);
        $this->assertEquals($params['error'], 'invalid_client');
        $this->assertEquals($params['error_description'], 'The client id supplied is invalid');
    }
    ...
    public function testNoRedirectUriSuppliedOrStoredResponse()
    {
        ...
        $this->assertEquals($response->getStatusCode(), 400);
        $this->assertEquals($params['error'], 'invalid_uri');
        $this->assertEquals($params['error_description'], 'No redirect URI was supplied or stored');
    }
    ...
    public function testRedirectUriFragmentResponse()
    {
        ...
        $this->assertEquals($response->getStatusCode(), 400);
        $this->assertEquals($params['error'], 'invalid_uri');
        $this->assertEquals($params['error_description'], 'The redirect URI must not contain a fragment');
    }
    ...
    public function testDoNotEnforceState()
    {
        ...
        $this->assertEquals($response->getStatusCode(), 302);
        $this->assertNotContains('error', $response->getHeaderLine('Location'));
    }
    ...
    public function testEnforceScope()
    {
        ...
        $this->assertEquals($response->getStatusCode(), 302);
        $parts = parse_url($response->getHeaderLine('Location'));
        parse_str($parts['query'], $query);
        ...
        $request = $request->withUri($request->getUri()->withQuery($query . '&scope=testscope'));
        $response = $server->handleAuthorizeRequest($request, new Response(), true);
        $params = json_decode((string) $response->getBody(), true);
    ...
    public function testInvalidRedirectUri()
    {
        ...
        $this->assertEquals($response->getStatusCode(), 400);
        $this->assertEquals($params['error'], 'redirect_uri_mismatch');
        $this->assertEquals($params['error_description'], 'The redirect URI provided is missing or does not match');
    }
    ...
    public function testNoRedirectUriWithMultipleRedirectUris()
    {
        ...
        $this->assertEquals($response->getStatusCode(), 400);
        $this->assertEquals($params['error'], 'invalid_uri');
        $this->assertEquals($params['error_description'], 'A redirect URI must be supplied when multiple redirect URIs are registered');
    }
    ...
    public function testRedirectUriWithValidRedirectUri()
    {
        ...
        $this->assertEquals($response->getStatusCode(), 302);
        $this->assertContains('code', $response->getHeaderLine('Location'));
    }
    ...
    public function testNoRedirectUriSuppliedDoesNotRequireTokenRedirectUri()
    {
        ...
        $params = json_decode((string) $response->getBody(), true);
        $this->assertEquals($response->getStatusCode(), 302);
        $this->assertContains('state', $response->getHeaderLine('Location'));
        $this->assertStringStartsWith('http://brentertainment.com?code=', $response->getHeaderLine('Location'));
